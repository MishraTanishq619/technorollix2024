  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`${digitalFont.className}  flex justify-around neon-text-red`}
        >
          <div className="flex items-center justify-end    transition-transform transform hover:scale-110">
            <ul className="navbar-links">
              <li
                ...
                // onDoubleClick={dropRev}
              >
                <div className="flex items-start justify-start text-red  transition-transform transform hover:scale-110">
                  <CiMenuFries />
                </div>
                <div id="dropdown" className="dropdown ">
                  <a
