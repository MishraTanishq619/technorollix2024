    ...
    <main className="w-full h-screen">
      ...
      <EventsDetails
        ...
        paragraph={
          <>
            <p>
              Calling all talented individuals! It's time to take the stage and
              dazzle us with your skills at our Talent Hunt event. Whether
              you're a poet, comedian, musician, artist, or a magician, this is
              your chance to shine. Compete against other talented individuals
              and let your creativity soar. Join us for a day filled with
              excitement, laughter, and unforgettable performances!
            </p>
          </>
        }
        subHeading="“Unleash Your Campus Star Power!”"
                  ...
                  <tr>
                    ...
                    <td>
                      <li className="text-ellipsis">
                        Your Unique Talents Like Magic, Toss Juggling, Shadow
                        Act etc..
                      </li>
                    </td>
                  </tr>
        ...
        rules={
          <>
            <h3 className="neon-text-red-light">
              Note:- For All The Sub-events Only Individual Participants are
              allowed!
            </h3>
            <br /> <p className="neon-text-red-lighter">OPEN MIC</p>
            <ol className="list-decimal">
              ...
              <li>
                Participants must bring any props or notes they require for
                their performance
              </li>
              <li>Time Limit : 5min for each category.</li>
              <li>No offensive language or content allowed.</li>
            </ol>
            <br /> <p className="neon-text-red-lighter">MUSICAL SHOWCASE</p>
            <ol className="list-decimal">
              <li>
                Participants must perform instrumental music using any chosen
                instrument.
              </li>
              <li>
                Participants must bring their own instruments and any necessary
                accessories (e.g.,picks, drumsticks).
              </li>
              <li>No pre-recorded music allowed.</li>
            </ol>
            <br />
            <p className="neon-text-red-lighter">ART AND CRAFTS</p>
            <ol className="list-decimal">
              <li>Participants must arrive 15 mins before the event begins.</li>
              <li>Crafts must be original creations.</li>
              <li>
                Participants must bring any materials they require for their
                performance.
              </li>
              <li>Maximum time limit :- 15 min.</li>
              <li>
                Finished crafts will be evaluated based on visual appeal and
                craftsmanship.
              </li>
            </ol>
            <br />
            <p className="neon-text-red-lighter">SPECIAL TALENTS</p>
            <ol className="list-decimal">
              <li>
                Showcase your unique talent in 3-5 minutes with originality and
                flair
              </li>
              <li>
                Safety first! Keep your performance safe for yourself and the
                audience.
              </li>
              <li>
                Impress the judges with your creativity, skill, and stage
                presence.
              </li>
              <li>
                Props are allowed, but they must be safe and enhance your act
              ...
              <li>
                Communicate any technical needs in advance for a smooth
                performance.
              </li>
              <li>Cheating or unfair play will result in disqualification.</li>
              <li>
                Make your talent shine in a short but memorable performance.
              </li>
            </ol>
