    ...
    <main className="w-full h-screen">
      ...
      <EventsDetails
        ...
        paragraph={
          <>
            <p>
              Engrossed with fun and Quiz-mania to tackle puzzles, riddles, and
              memes. Brush up your memory in the Technology, and General
              knowledge, build up curiosity and get the way out!!
            </p>
          </>
        }
        ...
        theme={
          <p>
            {' '}
            (for quiz): Current Affairs, Technical, Entertainment, Sports, Voice
            Recognition, Riddle’s, Mental Ability & Memory Question.
          </p>
        }
        ...
        rules={
          <>
            <ul>
              <li>
                The event will happen in 3 rounds and will be on the 21st of
                March 2024.
              </li>
              <li>
              ...
              <li>
                The results (for every level) will be decided based on their
                score.
              </li>
              <li>
                A team will consist of 3 members maximum. 1st round will be the
                elimination round.
              </li>
              <li>There will be negative markings (as per the questions).</li>
              <li>
                There would be (approx.) 20 questions and will be defined as per
                the levels.
              </li>
              <li>Participation Certificates for all participants.</li>
              <li>Top winners will be awarded prizes</li>
              <li>
                There is no elimination after 2nd round and all teams qualify
                for the final round.
              </li>
            </ul>
          </>
        ...
        rounds={
          <>
            <ul>
              <li>
                The event will happen in 3 rounds and will be conducted on the
                20th of March 2024.
              </li>
              <li>
                The system will be provided by the college only for the software
                Autocad, Solidworks & CREO. If the participant is interested in
                competing in any other software they can feel free to bring
                their system do bring system.
              </li>
              <li>
                The event will be performed by giving the participants a design
                and They will have to replicate the given design within a given
                time Frame.
              </li>
              <li>
                The competition will be held at CAD Modelling & Simulation Lab
                G-09.
              </li>
              <li>
                The event will be conducted in 3 rounds and the first two rounds
                will be a knock-out round.
              </li>
              <li>Participation Certificates for all participants.</li>
              <li>No electronic devices or phones are allowed.</li>
