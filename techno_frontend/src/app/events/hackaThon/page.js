	...
	return (
		<main className="w-full h-screen">
			...
			<EventsDetails
				...
				<p>In today's world, understanding human emotions is crucial for various applications, ranging from customer service to mental health support. However, accurately interpreting emotions from both facial expressions and vocal cues presents a significant challenge. In this hackathon, participants are tasked with developing an AI solution that can analyze live video and voice streams, accurately identify facial expressions and emotional tones, and provide meaningful statistical insights.</p><br/>
				<h1 className="neon-text-red-light">Problem Statement 2:</h1> <br/>
				<p>In today's digital age, collecting information through online forms is a common practice for various purposes, including surveys, registrations, feedback collection, and more. However, many existing form-building platforms lack flexibility and customization options, making it challenging for users to create forms tailored to their specific needs. The task is to develop a web and/or mobile application that provides a highly customizable and user-friendly platform for creating and managing online forms, akin to Google Forms, but with enhanced features and flexibility.</p><br/>
				</>}
				...
				subEvents={<>
					...
					<li><b>Statistical Analysis: </b>Once expressions are detected, the AI should provide statistical analysis, including frequency of different expressions, trends over time, and correlations between facial expressions and vocal cues.
					</li>
					<li><b>Customization Options: </b>Provide a wide range of customization options for form elements, including the ability to customize colors, fonts, sizes, and layout.
					</li>
					<li><b>Conditional Logic: </b>Implement conditional logic features that enable users to show or hide form fields based on previous responses, making the forms more dynamic and interactive.
					</li>
					<li><b>Multi-step Forms: </b>Support the creation of multi-step or multi-page forms to break down lengthy forms into smaller, more manageable sections, enhancing user experience.
					</li>
					<br/>
				</>}
				...
				rules={<>
					<li>
						There will be a lockdown of 6-8 hours for all teams.
					</li>
					<li>
						The number of participants in a team should be of 5 members.
					</li>
					<li>
						Teams are not allowed to leave the venue during the event.
					</li>
					<li>
						Selected team may get an opportunity to work with our Sponsers.
					</li>
					<li>
						Use of multiple devices for testing is allowed.
					</li>
					<li>
					...
					<li>
					Participants are free to use any programming languages, frameworks, or tools to develop their solutions.
					</li>
				</>}
