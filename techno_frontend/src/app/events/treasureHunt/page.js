    ...
    <main className="w-full h-screen">
      ...
      <EventsDetails
        ...
        paragraph={
          <>
            <p>
              TREASURE HUNT – THE MIND GAME Hey You!!! &quot;Join us on a
              thrilling adventure as we follow clues, solve puzzles, and
              overcome challenges to find a hidden treasure. It&#39;s all about
              fun, teamwork, and the excitement of discovery!&quot;
            </p>
          </>
        }
        ...
        rules={
          <>
            <ul>
              <li>
                All teams have to select their team leader with their team’s
                name.
              </li>
              <li>Do not misbehave with coordinators.</li>
              <li>Participants can’t take any help from others.</li>
              <li>Teams must stay together and not split up.</li>
              <li>
              ...
              <li>There should be only 5 members in a team.</li>
              <li>
                If the number of participating teams will exceed 30, then there
                will a prequalification round before the final event. (We will
                notify you by your email)
              </li>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Damaging the university properties (otherwise you have to
                    pay fine for it).
                  </li>
                  <li>They do not follow the given instructions.</li>
                  <li>All teams must reach before time.</li>
                </ul>
              </li>
            </ul>
          </>
