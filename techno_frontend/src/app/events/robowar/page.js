	...
	return (
		<main className="w-full h-screen">
			...
			<EventsDetails
				...
				rules={
					<div data-v-bf39338c="" class="detail-rules">
						...
						<ul data-v-bf39338c="">
							...
							<li data-v-bf39338c="">One participant cannot be part of more than one team.</li> <li data-v-bf39338c="">
							...
							<li data-v-bf39338c="">Participants must carry their Laptop for presentation.</li> <li data-v-bf39338c="">
