    ...
    <main className="w-full h-screen">
      ...
      <EventsDetails
        ...
        paragraph={
          <>
            <p>
              Unleash your inner voice! Join the Radio Jockey (RJ) Hunt and let
              your stories echo through the waves. Hunt and compete for the
              title of the ultimate campus voice. Are you ready to be heard?{' '}
            </p>
          </>
        }
        // subHeading="“Where Minds Clash and Ideas Illuminate”"
        ...
        rules={
          <>
            <ol>
              ...
              <ul>
                <li>
                  Participants must be full-time students of a college or
                  university..
                </li>
                <li>
                  Each participant can register individually or in a team but
                  not more than 2. (Can be modified if needed)
                </li>
              </ul>
              <li className="neon-text-red-lighter">Audition Format:</li>
              <ul>
                <li>
                  Auditions will be based on various skills such as
                  storytelling, voice modulation, spontaneity, and wit.
                </li>
                <li>Time limit for each participant during auditions.</li>
              </ul>
              <li className="neon-text-red-lighter">Content Guidelines:</li>
              <ul>
                <li>
                  Content must be appropriate, avoiding any offensive language
                  or topics.
                </li>
                <li>Originality is encouraged, but adaptations are allowed.</li>
              </ul>
              <li className="neon-text-red-lighter">Technical Requirements:</li>
              <ul>
                <li>
                  Participants must bring their own music or sound effects if
                  they choose to incorporate them.
                </li>
                <li>Limited time for technical setup during auditions.</li>
              </ul>
            </ol>
          </>
        }
        ...
        rounds={
          <>
            <ul>
              <li>
                1st round Auditions based on voice Modulation, Narration,
                Storytelling, Spontaneity, Creativity and Originality etc. ping.
              </li>
              <li>
                After audition participants will be given time to prepare their
                scripts based on various themes provided after clearing the
                auditions. For pre-finale or Round 1 of the competition the
                participants have to provide a recorded audio clip (recording
                must be done in the presence of the event managers and one of
                the faculty-coordinators). The clips will be uploaded on the
                official Instagram account of RJ Hunt. Participant have to
                promote their respective post to get good comments and likes,
                however the final judgment will include experts remarks also.
              </li>
              <li>
                In the finale round i.e., Round 3, participants have to conduct
                an offline (classroom) podcast in-front of the audience and
                judges. (Terms and conditions will be updated after clearing
                Round 2 (pre-finale)).
              </li>
            </ul>
          </>
        ...
        judgeMentalCriteria={
          <>
            ...
            <ul>
              <li>
                Voice Modulation (20 points): Ability to modulate voice for
                different moods and tones.
              </li>
              <li>
                Creativity and Originality (20 points): Uniqueness of content
                and creative storytelling.
              </li>
              <li>
                Spontaneity (15 points): Quick thinking and responses to
                unexpected situations.
              </li>
              <li>
                Engagement with Audience (15 points): Connection with listeners,
                maintaining interest.
              </li>
              <li>
                Overall Presentation (30 points): Overall impression, flow, and
        ...
        eventVenue={
          <p>EEE Seminar Hall, First Floor, New Engineering building </p>
        }
        facultyCoordinators={
          <table>
            <tbody>
