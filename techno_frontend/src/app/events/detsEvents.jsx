      ...
      <div className="pt-10 mt-10 w-full flex flex-col items-center gap-10">
        ...
        >
          ...
          >
            ...
            <div
              className={`${dataFont.className} absolute left-4 bottom-6 px-3 py-1 md:py-4 text-1xl md:text-2xl neon-text-blue-light font-bold`}
            >
              Prize: {prize}
            </div>
          </div>
          ...
          >
            <div
              className={`${headingFont.className} neon-text-red-light px-3 py-1 md:py-4 text-2xl md:text-4xl font-bold`}
            >
              {heading}
            </div>
            <div
              className={`${dataFont.className}  px-3 py-1 md:py-4 text-1rem md:text-4rem font-medium text-justify`}
            >
              {paragraph}
            </div>
            <div
              className={`${headingFont.className} neon-text-red-light px-3 py-1 md:py-4 text-1rem md:text-4rem font-medium text-justify`}
            >
              {subHeading}
            </div>
            ...
            <div className="mt-1 md:py-0 text-justify">
              ...
              <div
                className={`text-3rem ml-5 ${dataFont.className}  text-1xs md:text-1xl font-medium max-w-[85%]`}
              >
                <ul className="list-disc">{subEvents}</ul>
              </div>
            </div>
            <div className="mt-1 md:py-0 text-justify">
              <h2
              ...
              <div
                className={`text-3rem ml-5 ${dataFont.className}  text-1xs md:text-1xl font-medium max-w-[85%]`}
              >
                <ul className="list-disc">{reason}</ul>
              </div>
            </div>
            <div className="mt-2 md:py-4 text-justify">
              ...
              <div
                className={`text-3rem ml-5 ${dataFont.className}  text-1xs md:text-1xl font-medium max-w-[85%]`}
              >
                <ul className="list-disc">{rules}</ul>
              </div>
            </div>
            ...
            <div className="mt-2 md:py-4 text-justify">
              ...
              <div
                className={`text-3rem ml-5 ${dataFont.className}  text-1xl md:text-1xl font-medium max-w-[85%] `}
              >
                {judgeMentalCriteria}
              </div>
            </div>
            <div className="mt-2 md:py-4 text-justify flex flex-wrap">
              ...
              <div
                className={`text-3rem ml-5 ${dataFont.className}  text-1xl md:text-2xl font-medium max-w-[85%] `}
              >
                {eventVenue}
              </div>
            </div>
