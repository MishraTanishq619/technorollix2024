    ...
    <main className="w-full h-screen">
      ...
      <EventsDetails
        ...
        paragraph={
          <>
            <p>
              OPJU brings you an extraordinary platform “MASTERCHEF” to showcase
              your talents and let the world know your taste.
            </p>
          </>
        }
        subHeading="Good food is good mood"
        ...
        rules={
          <>
            ...
            <li>
              Performance should be within the time limit which will be
              intimated later.
            </li>
            <li>
              Contents should not be offensive, politically driven, gender
              biased, personal comments or any sensitive topic
            </li>
        ...
        rounds={
          <>
            <li>
              The number of rounds will be decided based on the entries. This
        ...
        judgeMentalCriteria={
          <>
            ...
            <li>Each parameter contains 10 marks</li>
            <li>
              The parameter of judgement may change which will be intimated
              later
            </li>
          </>
        }
