    ...
    return (
        <div className="w-full h-screen flex flex-wrap items-start justify-evenly">
            ...
            {events.map((event, index) => (<>
                ...
                <ThreeDCardDemo prize={event.priceMoney} title={event.eventName} description={event.eventDescription} members={event.teamSize} entryFee={event.entryFee} onClick={()=>window.location.href = `/events/startUp_event`}/>
            </>
