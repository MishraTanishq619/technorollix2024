...
export default function RootLayout({ children }) {
	return (
		<GoogleOAuthProvider clientId="836755220699-ojv84oup2nfa7li643q0jssqiftnk6o5.apps.googleusercontent.com">
			<html lang="en">
				<body className="w-full h-full mt-16  bg-cover bg-fixed bg-no-repeat bg-center bg-[url('/star-wars-fight.png')] flex flex-wrap gap-0 items-center overflow-y-scroll">
